...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY3JoaXMzNSIsImEiOiJjazhzd2VoYmYwODRwM3Bwa2NyZmZ4bms1In0.OgTcVDLx3HVHh_YwZxabpQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/crhis35/ck8swq1ew0jxe1ipoxjd694dn',
    scrollZoom: false //   center: [latitud,longitud],
    //   zoom: 10,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); // Add popud
...
var stripe = Stripe('pk_test_5JWT2RnksRGKoBa0AKU5FRqw004sjgr2yn');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout fomr + chance credit card
